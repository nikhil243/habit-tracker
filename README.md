...
3. Enter the habit name and pick a base color.
4. Click on the day squares to cycle intensity (0 → 1 → 2 → 3 → 0).
5. View weekly progress via the progress bar at the bottom of each habit card.
